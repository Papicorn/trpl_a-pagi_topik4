<?php 
    ...
    if(!isset($_SESSION['email'])){
        ...
        $cek_berita = mysqli_query($koneksi, "SELECT * FROM news");
        $cek_ulasan = mysqli_query($koneksi, "SELECT * FROM ulasan");
        $cek_community = mysqli_query($koneksi, "SELECT * FROM community WHERE status = 'disetujui'");
        $cek_user1 = mysqli_query($koneksi, "SELECT * FROM user WHERE level = 'user'");
        ...
        $jumlah_berita = mysqli_num_rows($cek_berita);
        $jumlah_ulasan = mysqli_num_rows($cek_ulasan);
        $jumlah_user1 = mysqli_num_rows($cek_user1);
        $jumlah_community = mysqli_num_rows($cek_community);
