...
<div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?= $weburl ?>/dashboard/admin/index.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?= $weburl ?>/dashboard/admin/sidebar/berita.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?= $weburl ?>/dashboard/admin/sidebar/komunitas.php" class="nav-link">
