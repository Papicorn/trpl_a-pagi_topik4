        ...
        <div class="row mb-2">
          ...
          <div class="col-3 d-flex justify-content-end">
                  <div class="input-group input-group-sm col-12 pr-0 d-flex justify-content-end">
                      <a href="../" class="btn btn-success"><i class="fas fa-arrow-left"></i> Kembali</a>
                  </div>
          </div>
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
              ...
              <table class="table table-hover table-bordered text-nowrap">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?= $tgl_bergabung; ?></td>
                    <td align="center"><a name="show" href="<?= $weburl ?>/dashboard/admin/sidebar/profile-volunteer.php?id_user=<?= $id_user ?>" class="btn btn-success btn-sm"><i class="fas fa-user"></i> Profile</a>
