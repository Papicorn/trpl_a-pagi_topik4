    ...
    <div class="d-flex justify-content-between">
        <div class="dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
            <a class="dropdown-item" href="<?= $weburl; ?>/dashboard/admin/index.php">Dashboard</a>
            <a class="dropdown-item" href="<?= $weburl; ?>/dashboard/admin/sidebar/berita.php">Berita</a>
            <a class="dropdown-item" href="<?= $weburl ?>/dashboard/admin/sidebar/komunitas.php">Komunitas</a>
