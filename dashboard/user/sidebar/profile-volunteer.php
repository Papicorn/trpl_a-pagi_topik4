...
$a = $_SESSION['email'];
$data_user = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT * FROM user WHERE username = '$a' OR email = '$a'"));
...
$cek_kegiatan = mysqli_query($koneksi, "SELECT * FROM gabung_kegiatan WHERE id_user = '$id_user1'");
$cek_ulasan = mysqli_query($koneksi, "SELECT * FROM ulasan WHERE id_user = '$id_user1'");
$cek_komentar = mysqli_query($koneksi, "SELECT * FROM komentar WHERE id_user = '$id_user1'");
        ...
        <div class="row">
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <?php
                $cek_user = mysqli_query($koneksi, "SELECT * FROM user WHERE id_user = '$id_user1'");
          ...
          <div class="col-md-9">
            <div class="card">
              ...
              <div class="card-body">
                <div class="tab-content">
                  <div class="active tab-pane border-bottom">
                    ...
                    <?php
                    $cek_aktivitas = mysqli_query($koneksi, "SELECT * FROM aktivitas WHERE id_user = '$id_user1' ORDER BY waktu DESC LIMIT 5");
              ...
              <?php
                    $cek_gabungK = mysqli_query($koneksi, "SELECT * FROM gabung_kegiatan WHERE id_user = '$id_user1' ORDER BY waktu_bergabung DESC LIMIT 5");
                    ...
                    while ($sql2 = mysqli_fetch_assoc($cek_gabungK)) {
                        ...
                        $data_ulsn = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT * FROM ulasan WHERE id_kegiatan = '$id_kegiatan' AND id_user = '$id_user1'"));
                    ?>
